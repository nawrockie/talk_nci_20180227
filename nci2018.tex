...
\begin{itemize}
\item Originally discovered in complex with Ro60 protein, a target of 
  autoimmune antibodies in patients with systemic lupus erythematosus
  and Sjogren's synodrome. 
...
\item Ro60 homologs are encoded in most animal genomes and about 5\% of
  bacteria 
\item IMAGE OF 4 HUMAN Y RNAs from ``Functional roles of non-coding Y
  RNAs''
